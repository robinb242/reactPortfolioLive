    ...
    return (
      <div>
        <Menu vertical id='vertMenuContainer'>
          ...
          <Menu.Item href='https://www.facebook.com/robin.bertuccelli/' target='_blank' className='socialIcons'>
            <Image src={require('../../assets/images/icons/if_facebook.png')}  alt="Facebook" size='small' />
          </Menu.Item>

          <Menu.Item href='https://github.com/robinb242' target='_blank' className='socialIcons'>
            <Image src={require('../../assets/images/icons/if_social-github.png')}  alt="Github" size='small' />
          </Menu.Item>
          

          <Menu.Item href='https://www.linkedin.com/in/robin-bertuccelli/' target='_blank' className='socialIcons'>
            <Image src={require('../../assets/images/icons/if_linkedin.png')}  alt="LinkedIn" size='small' />
          </Menu.Item>
          

          <Menu.Item href='https://www.imdb.com/name/nm3031887/?ref_=fn_al_nm_1' target='_blank' className='socialIcons'>
