        ...
        <Grid>
            <Grid.Row columns={2}>
                ...
                <Card id="tattooUndergroundCard">
                   <Image src={require('../../assets/images/tattooUnderground.png')} size="medium" href="https://player.vimeo.com/video/47910614" target="_blank" alt="Tattoo Underground"/>
                 ...
                 <Card id ="feminineMystiqueCard">
                     <Image src={require('../../assets/images/feminineMystique200.png')} size="medium" href="https://vimeo.com/900342" target="_blank" alt="The Feminine Mystique" />
