        ...
        <Grid>
            <Grid.Row columns={2}>
                ...
                <Card className="portfolioCard" id="neilGaimanCard">
                   <Image src={require('../../assets/images/neilGaiman.png')} size="medium" href="https://www.youtube.com/watch?v=msRTrXiolS8" target="_blank" />
                ...
                <Card className="portfolioCard" id="brettFavreCard">
                     <Image src={require('../../assets/images/brettFavre.png')} size="medium" href="https://www.youtube.com/watch?v=msRTrXiolS8" target="_blank" />
