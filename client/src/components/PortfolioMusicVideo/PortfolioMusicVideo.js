        ...
        <Grid>
            <Grid.Row columns={2}>
                ...
                <Card id="dessaGhostsCard">
                   <Image src={require('../../assets/images/dessaGhosts.png')} size="medium" href="https://www.youtube.com/watch?v=B6A8T6qWPBo" target="_blank" alt="Dessa - Call Off Your Ghosts"/>
                 ...
                 <Card id="bethRestCard">
                     <Image src={require('../../assets/images/bethRest2.png')} size="medium" href="https://www.youtube.com/watch?v=wPSvDoqUl8Q" target="_blank" alt="Bon Iver - Beth Rest" />
            ...
            <Grid.Row columns={2}>
                    ...
                    <Card id="dessaAlibiCard">
                       <Image src={require('../../assets/images/dessaAlibi.png')} size="medium" href="https://www.youtube.com/watch?v=J2_aY9gYTF0" target="_blank" alt="Dessa - Alibi"/>
                        <h3>Dessa: Alibi </h3>
                     ...
                     <Grid.Column>
                     <Card id="owlCityCard">
                         <Image src={require('../../assets/images/owlCity.png')} size="medium" href="https://www.youtube.com/watch?v=Z3gstWVGnSM&list=RDZ3gstWVGnSM" target="_blank" alt="Owl City - Metropolis"/>
                        <h3>The Jingle Dress
                        </h3>
